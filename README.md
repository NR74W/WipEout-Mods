<img src="https://github.com/user-attachments/assets/9ca254c4-d7c8-4478-b178-4708f1e2a49a" width="150" align="right">  
<img src="https://github.com/user-attachments/assets/b939beb0-1b82-436a-b174-7fb29a8a3e8b" width="150" align="right">  
<img src="https://github.com/user-attachments/assets/04b5ba85-c9a4-4df7-9a5a-5ca42e59ccbf" width="150" align="right">  
...
```
> [!NOTE]
> After launching a game from the compilation, the other game can be accessed by pressing Select from the main menu in both games.
...
*-* Frontend Music `WPCE02197DFEMUSIC` : Changes the menu music to one from another WipEout game
...
- Frontend Music `FEMUSIC` : Changes the menu music to one from another WipEout game
- Frontend Video `FEVIDEO` : Adds a dark version of the background from the main menu of WipEout HD
- HD Wrecked Ships `HDWSHIPS` : Improves the models used for destroyed ships
...
- Alternative Skin `WPCE02025CSKIN` : Replaces the interface with a dark theme  
- WipEout Intros `WPCE02025CFMV` : Adds the intro sequences from other WipEout games
